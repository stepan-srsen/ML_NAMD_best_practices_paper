...
\begin{itemize}
\item Recognize the phase problem of the coupling terms (see Section~\ref{sec:modeltrain}):%(the arbitrary phase factor of the wave function leads to arbitrary signs of coupling terms (NAC data))
\begin{itemize}
